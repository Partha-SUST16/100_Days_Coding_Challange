...
//just check if any line intersect with other :P
//donno how the above code works just copy it and the rest is miracle :P
int main()
{
	polygon p1,p2;
	p1.input(4);p2.input(4);
	p1.getline();
	p2.getline();
